...
for ($i = 0; $i <= 100; $i++) {
    ...
    $city = ['Aborlan', 'Agutaya', 'Araceli', 'Balabac', 'Bataraza', "Brookes Point", 'Busuanga', 'Cagayancillo', 'Coron', 'Culion', 'Cuyo', 'Dumaran', 'El Nido', 'Kalayaan', 'Linapacan', 'Magsayasay', 'Narra', 'Queson', 'Rizal', 'Roxas', 'San Vicente', 'Sofronio', 'Taytay'];
